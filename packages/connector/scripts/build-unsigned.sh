...
codesign --force --deep --sign - --entitlements build/entitlements.mac.unsigned.plist "dist/mac-arm64/${APP_DISPLAY_NAME:-Agent Connector}.app"
xattr -cr "dist/mac-arm64/${APP_DISPLAY_NAME:-Agent Connector}.app"
