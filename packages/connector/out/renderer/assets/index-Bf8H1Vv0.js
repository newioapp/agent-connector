...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen w-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 shrink-0", style: { WebkitAppRegion: "drag" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 pb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-sm font-semibold", style: { color: "var(--text)" }, children: "Agents" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col items-center justify-center px-4", style: { color: "var(--text-muted)" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { size: 32, className: "mb-2 opacity-40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs", children: "No agents yet. Click + to connect your first agent." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center border-t px-4 py-3", style: { borderColor: "var(--border)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col", style: { background: "var(--bg)" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 shrink-0", style: { WebkitAppRegion: "drag" } }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col items-center justify-center", style: { color: "var(--text-muted)" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { size: 48, className: "mb-3 opacity-30" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "Select an agent or add a new one to get started." })
      ] })
    ] })
  ] });
}
